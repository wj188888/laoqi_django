...
urlpatterns = [
    ...
    path('register/', auth_views.LogoutView.as_view(template_name='account/register.html'), name='user_register'),
    ...
    path('edit-my-information/', views.mysql_edit, name="edit_my_information"),
